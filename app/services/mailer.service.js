...
// Ensure environment variables from .env are loaded even if this module is imported early
dotenv.config();
...
export class MailerService {
    ...
    // Método específico para confirmación de compra
    async sendPurchaseConfirmation({ to, userName, ticket }) {
        return this.send({
            to,
